          ...
          <div className="posttop">
            <div className="posttopleft">
              <Link to={`/profile/${info.username}`}>
                <img
                  alt="sorry"
                  className="posttopleftprofile"
                  src={
                    info.profilePicture !== ''
                      ? `/images/${info.profilePicture}`
              ...
              <div className="postleftnames">
                ...
                <span className="postdate">
                  {format(data.createdAt)} <PublicIcon className="publicIcon" />
                </span>
              </div>
            </div>
            ...
            <div className="posttopright">
              {!option ? (
                ...
                <ClearIcon className="verticalicon" onClick={Showuser} />
              )}
              <div className="optionsforpost">
                ...
                >
                  ...
                  <li onClick={Showuser}>
                    <Person />
                    <Link to={`/profile/${info.username}`}>Profile</Link>
                  </li>
                  <li onClick={Showuser}>
                    <Share />
                    Share
          ...
          <div className="likes">
            <div className="first_section">
              <img
                alt="sorry"
                className="likeimg"
                src={process.env.PUBLIC_URL + '/assets/icons/likes.png'}
              ></img>
          ...
          <div className="allsection">
            ...
            <div className="iconbottom">
              <img
                ...
                width="22"
                height="22"
                src={process.env.PUBLIC_URL + '/assets/icons/share.png'}
              ></img>
              <span>Share</span>
            </div>
          </div>
